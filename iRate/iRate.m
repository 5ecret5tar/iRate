...
- (void)didDismissAlert:(__unused id)alertView withButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    NSInteger remindButtonIndex = [self showRemindButton]? 1: 0;
    NSInteger cancelButtonIndex = [self showCancelButton]? remindButtonIndex + 1: 0;
